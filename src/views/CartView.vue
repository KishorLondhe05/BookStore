        ...
        <tbody>
          <tr v-for="(book,index) in addedBooks" :key="index">
            ...
            <td>
              ...
              <button class="btn btn-primary" @click="incrementItem(index)">+</button>
            </td>
          </tr>
        </tbody>
      </table>
          ...
          <div class="col-md-6 txt shadow p-4">
            ...
            <div class="row">
              <div class="col-md-6 d-grid d-md-block">
                <button class="btn btn-primary mt-2" @click="verify()"> Verify </button>
              </div>
            </div>
          </div>
...
export default{
  ...
  methods:{
    ...
    incrementItem(idx) {
    this.addedBooks[index].quantity = (this.addedBooks[index].quantity || 0) + 1;
    this.payble();
  },
    payble(){
